...
abstract class Veiculo(val indetificador: String) : Movimentavel {
    ...
    var dataDeAquisicao: String = LocalDate.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")).toString()
    ...
    override fun toString(): String = "$identificador | $dataDeAquisicao | Posicao | x:${posicao.x} | y:${posicao.y}"
